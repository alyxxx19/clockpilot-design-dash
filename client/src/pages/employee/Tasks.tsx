          ...
          <Card className="max-w-md w-full">
            ...
            <CardContent className="text-center space-y-4">
              <p className="text-muted-foreground">
                La gestion des tâches est actuellement en cours de développement. 
              ...
              <div className="text-left space-y-2 bg-muted/50 p-4 rounded-lg">
                <div className="flex items-center space-x-2 text-sm">
                  ...
                  <span>Gérer vos tâches quotidiennes</span>
                </div>
                <div className="flex items-center space-x-2 text-sm">
                  <div className="w-2 h-2 bg-primary rounded-full"></div>
                  <span>Suivre l'avancement de vos projets</span>
                </div>
                <div className="flex items-center space-x-2 text-sm">
                  <div className="w-2 h-2 bg-primary rounded-full"></div>
                  <span>Organiser vos priorités</span>
                </div>
                <div className="flex items-center space-x-2 text-sm">
                  <div className="w-2 h-2 bg-primary rounded-full"></div>
                  <span>Collaborer avec votre équipe</span>
                </div>
              </div>
